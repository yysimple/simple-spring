...
public class ClassPathBeanDefinitionScanner extends ClassPathScanningCandidateComponentProvider {
    ...
    public void doScan(String... basePackages) {
        ...
        registry.registerBeanDefinition("com.simle.simplespring.context.annotation.internalAutowiredAnnotationProcessor", new GenericBeanDefinition(AutowiredAnnotationBeanPostProcessor.class));
    }
