...
public abstract class AbstractAutowireCapableBeanFactory extends AbstractBeanFactory implements AutowireCapableBeanFactory {
    ...
    Logger logger = Logger.getLogger(AbstractAutowireCapableBeanFactory.class.getName());
    ...
    protected Object createBean(String beanName, BeanDefinition beanDefinition, Object[] args) throws BeanCreationException {
        ...
        // 单例的情况下才放入缓存中，否则从新创建，spring中会稍微复杂一丢丢
    ...
    protected Object doCreateBean(final String beanName, final BeanDefinition beanDefinition, final @Nullable Object[] args)
        ...
        try {
            ...
            // ... todo 其他处理方法
            // 处理bean循环依赖问题, 两个true == this.allowCircularReferences && isSingletonCurrentlyInCreation(beanName));
            boolean earlySingletonExposure = (beanDefinition.isSingleton() && true && true);
