...
import com.simple.simplespring.context.annotation.ClassPathBeanDefinitionScanner;
    ...
    protected void doLoadBeanDefinitions(InputStream inputStream) throws ClassNotFoundException, DocumentException {
        ...
        if (null != componentScan) {
            ...
            if (StrUtil.isEmpty(scanPath)) {
                throw new BeanCreationException("The value of base-package attribute can not be empty or null");
            }
